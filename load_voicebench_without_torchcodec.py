#!/usr/bin/env python3
"""
Load VoiceBench dataset without torchcodec dependency

This script loads the VoiceBench dataset using alternative methods that don't require torchcodec.
"""
...
def load_voicebench_commoneval_alternative(max_samples: int = 10) -> List[Dict[str, Any]]:
    """
    Load VoiceBench commoneval dataset using alternative method.
    
    This uses the HuggingFace datasets API directly without audio decoding.
    """
    try:
        from datasets import load_dataset
        
        print("Loading VoiceBench commoneval dataset...")
...
def main():
    ...
    samples = load_voicebench_commoneval_alternative(max_samples=10)
